...
const char* WIFI_SSID = "THILINA";
const char* WIFI_PASSWORD = "972430390";

String HOST_NAME = "http://192.168.137.69";
String PATH_NAME = "/LuminaSmart/retrieve.php";
